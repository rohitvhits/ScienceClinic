...
class LogoMasterHelper
{
    ...
    public static function update($data, $where)
    {
        ...
        $update = Logo::where($where)->update($data);
        return $update;
    }
    ...
    public static function getList(){
        $query = Logo::where('id')->get();
        return $query;
    }
    public static function getDetailsById($id){
        $query = Logo::where('id',$id)->first();
        return $query;
    }

    public static function getLogoList(){
        $query = Logo::orderBy('id','desc')->get();
        return $query;
    }

    public static function getLogoListNew(){
        $query = Logo::orderBy('id', 'desc')->take(4)->get();
        return $query;
    }
