...
class TutorSupportController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('frontend.tutor.tutor-support', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect("/tutor-support-ticket?addpopup=1")
            ...
            if ($insert) {
                ...
                return redirect('tutor-support-ticket');
            } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), $rules, $messsages);
        if ($validator->fails()) {
            return redirect("/tutor-support-ticket?editpopup=1&id=" . $id)
    ...
    public function supportAjaxList(Request $request)
    {
        ...
        return view('frontend.tutor.tutor-support-ajax', $data);
    }
