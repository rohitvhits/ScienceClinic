                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            <h3 class="card-label font-weight-bolder text-dark">Pay Claim Form List</h3>
                        </div>
...
<div id="kt_demo_panel" class="offcanvas offcanvas-right p-10 ">
    ...
    <div class="offcanvas-content">
        ...
        <div class="form-group row">
            <label class="col-4 col-form-label">Teacher Name</label>
            <div class="col-8">
                <input class="form-control" placeHolder="Enter Teacher Name" type="text" name="name" id="name" autocomplete="off">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-4 col-form-label">Student Name</label>
            <div class="col-8">
                <input class="form-control" placeHolder="Enter Student Name" type="text" name="student_name" id="student_name" autocomplete="off">
            </div>
        </div>
        <div class="form-group row">
...
<script>
    var _AJAX_LIST = "{{ route('pay-claim-form-list-ajax') }}";
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function() {
                        $.ajax({
                            method: "POST",
                            url: "{{ url('delete-pay-claim-form') }}/" + Id,
                            data: {
                                '_token': '{{ csrf_token() }}',
                                '_method': "DELETE",
                                'id': Id
