                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control validate_field" placeholder="Enter Student Name" data-msg="Student Name" name="student_name" id="student_name" autocomplete="off">
