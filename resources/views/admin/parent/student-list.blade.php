                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            <h3 class="card-label font-weight-bolder text-dark">Student Register List</h3>
                        </div>
                        <div class="card-toolbar">
                            ...
                            <a href="{{route('student-add')}}" class="btn btn-primary mr-2">
...
<script>
    var _AJAX_LIST = "{{ route('student-list-ajax') }}";
    ...
    function deleteDetail(Id) {
        ...
        $.confirm({
            title: 'Delete!',
            content: 'you want to delete this student data?',
            buttons: {
                formSubmit: {
                    text: 'Delete',
                    btnClass: 'btn-danger',
