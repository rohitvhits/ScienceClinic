                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control validate_field" placeholder="Exam Board/Subject" autocomplete="off" maxlength="100" id="paper_title" type="text" data-msg="Exam Board/Subject" name="paper_title" value="{{$basic_details->paper_title}}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control validate_field" placeholder="Paper Number" maxlength="100" autocomplete="off" id="paper_sub_title" type="text" data-msg="Paper Number" name="paper_sub_title" value="{{$basic_details->paper_sub_title}}">
