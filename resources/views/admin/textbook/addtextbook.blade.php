                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control validate_field" placeholder="Title" maxlength="30" autocomplete="off" id="text_book_title" type="text" data-msg="Title" name="text_book_title">
