...
@section('title', 'Add Our Featured')
@section('content')
<style>
    .remove-btn1 {
        margin-top: 26.5px;
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            <h3 class="card-label font-weight-bolder text-dark">Add Our Featured</h3>
                        </div>
                    </div>

                    <form class="form" id="submitid" method="post" action="{{ route('our-featured-store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Title" class="form-control txtOnly" autocomplete="off" id="title" type="text" data-msg="Title" value="{{ old('title')}}" name="title" maxlength=255>
