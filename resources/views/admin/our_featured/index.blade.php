...
@section('title', 'Our Featured List')
@section('content')
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            <h3 class="card-label font-weight-bolder text-dark">Our Featured List</h3>
                        </div>
                        <div class="card-toolbar">
                            ...
                            <!--end::Dropdown-->
                            <!--begin::Button-->
                            <a href="{{ route('our-featured-create') }}" class="btn btn-primary mr-2">
                                <span class="svg-icon svg-icon-md">
...
<script>
    var _AJAX_LIST = "{{ route('our-featured-ajax') }}";
