        ...
        <div class="d-flex flex-row">
            ...
            <div class="flex-row-fluid">
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <form class="form" id="submitid" method="post" action="{{route('tutor-form.update',$formData->id)}}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="tuition_day" id="tuition_day" class="form-control validate_field">
                                            ...
                                            <option value="{{$val}}" @if($val == $formData->day_of_tution) selected @endif>
                                                {{$key}}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control validate_field" placeholder="Enter Rate" maxlength="5" onkeypress="return isNumber(event)" autocomplete="off" value="{{$formData->rate}}" id="rate" type="text" data-msg="Student Name" name="rate">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="month" id="month" class="form-control validate_field">
                                            ...
                                            <option value="{{$key}}" @if($key == $formData->month) selected @endif>{{$val}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- <select name="tuition_time" id="tuition_time" class="form-control validate_field">
                                            ...
                                            @if($formData->tution_time == "24:00:00-01:00:00")
                                            <option value="24:00:00-01:00:00" selected>
                                                12am- 1am
                                            </option>
                                            @else
                                            ...
                                            @endif
                                            @if($formData->tution_time == "01:00:00-02:00:00")
                                            <option value="01:00:00-02:00:00" selected>
                                                1am - 2am
                                            </option>
                                            @else
                                            ...
                                            @endif
                                            @if($formData->tution_time == "02:00:00-03:00:00")
                                            <option value="02:00:00-03:00:00" selected>
                                                2am - 3am
                                            </option>
                                            @else
                                            ...
                                            @endif
                                            @if($formData->tution_time == "03:00:00-04:00:00")
                                            <option value="03:00:00-04:00:00" selected>
                                                3am - 4am
                                            </option>
                                            @else
                                            ...
                                            @endif
                                            @if($formData->tution_time == "04:00:00-05:00:00")
                                            <option value="04:00:00-05:00:00" selected>
                                                4am - 5am
                                            </option>
                                            @else
                                            ...
                                            @endif
                                            @if($formData->tution_time == "05:00:00-06:00:00")
                                            <option value="05:00:00-06:00:00" selected>
                                                5am - 6am
                                            </option>
                                            @else
                                            ...
                                            @endif
                                            @if($formData->tution_time == "06:00:00-07:00:00")
                                            <option value="06:00:00-07:00:00" selected>
                                                6am - 7am
                                            </option>
                                            @else
                                            ...
                                            @endif
                                            @if($formData->tution_time == "07:00:00-08:00:00")
                                            <option value="07:00:00-08:00:00" selected>
                                                7am - 8am
                                            </option>
                                            @else
                                            ...
                                            @endif
                                            @if($formData->tution_time == "08:00:00-09:00:00")
                                            ...
                                            @endif
                                            @if($formData->tution_time == "09:00:00-10:00:00")
                                            ...
                                            @endif
                                            @if($formData->tution_time == "10:00:00-11:00:00")
                                            ...
                                            @endif
                                            @if($formData->tution_time == "11:00:00-12:00:00")
                                            ...
                                            @endif
                                            @if($formData->tution_time == "12:00:00-13:00:00")
                                            <option value="12:00:00-13:00:00" selected>
                                                12pm - 1pm
                                            </option>
                                            @endif
                                            @if($formData->tution_time == "13:00:00-14:00:00")
                                            ...
                                            @endif
                                            @if($formData->tution_time == "14:00:00-15:00:00")
                                            ...
                                            @endif
                                            @if($formData->tution_time == "15:00:00-16:00:00")
                                            ...
                                            @endif
                                            @if($formData->tution_time == "16:00:00-17:00:00")
                                            ...
                                            @endif
                                            @if($formData->tution_time == "17:00:00-18:00:00")
                                            ...
                                            @endif
                                            @if($formData->tution_time == "18:00:00-19:00:00")
                                            ...
                                            @endif
                                            @if($formData->tution_time == "19:00:00-20:00:00")
                                            ...
                                            @endif
                                            @if($formData->tution_time == "20:00:00-21:00:00")
                                            <option value="20:00:00-21:00:00" selected>
                                                8pm - 9pm
                                            </option>
                                            @else
                                            ...
                                            @endif
                                            @if($formData->tution_time == "21:00:00-22:00:00")
                                            <option value="21:00:00-22:00:00" selected>
                                                9pm - 10pm
                                            </option>
                                            @else
                                            ...
                                            @endif
                                            @if($formData->tution_time == "22:00:00-23:00:00")
                                            <option value="22:00:00-23:00:00" selected>
                                                10pm - 11pm
                                            </option>
                                            @else
                                            ...
                                            @endif
                                            @if($formData->tution_time == "23:00:00-24:00:00")
                                            <option value="23:00:00-24:00:00" selected>
                                                11pm - 12am
                                            </option>
                                            @else
                                        ...
                                        <input type="hidden" id="tution" value="{{$formData->tution_time}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control validate_field" placeholder="Enter Commission" autocomplete="off" id="commission" onkeypress="return isNumber(event)" maxlength="2" type="text" data-msg="Student Name" value="{{$formData->commission}}" name="commission">
...
<script>
    var time = $('#tution').val();
    var startTimeVal = time.split('-');
    var getStartTime = startTimeVal[0];
    var startTime = moment(getStartTime, "h:mm:ss").format("H:mm:ss A");
