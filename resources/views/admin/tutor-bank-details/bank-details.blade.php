...
@section('title', 'Tutor Bank Details')
@section('content')
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            <h3 class="card-label font-weight-bolder text-dark">Bank Account Details</h3>
                        </div>
...
<div id="kt_demo_panel" class="offcanvas offcanvas-right p-10 ">
    ...
    <div class="offcanvas-content">
        ...
        <div class="form-group row">
            <label class="col-4 col-form-label">Account Holder Name</label>
            <div class="col-8">
                <input type="text" name="holder_name" id="holder-name" class="form-control">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input type="text" name="bank_ac_no" id="bank-ac-no" class="form-control">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-4 col-form-label">Bank Sort Code</label>
            <div class="col-8">
                <input type="text" name="bank_code" id="bank-code" class="form-control">
            </div>
        </div>
        <!--end::Wrapper-->
        <!--begin::Purchase-->
...
<script>
    var _AJAX_LIST = "{{ route('tutor-bank-detail-ajax') }}";
    function ajaxList(page) {
        var holderName = $('#holder-name').val();
        var bankName = $('#bank-name').val();
        var bankAcNo = $('#bank-ac-no').val();
