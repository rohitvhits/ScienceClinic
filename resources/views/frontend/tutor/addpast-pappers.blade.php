                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="card-title align-items-start flex-column">
                            ...
                            <h3 class="card-label font-weight-bolder text-dark">Add Past Paper</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control validate_field" placeholder="Exam Board/Subject" autocomplete="off" id="paper_title" type="text" data-msg="Exam Board/Subject" name="paper_title">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control validate_field" placeholder="Paper Number" autocomplete="off" id="paper_sub_title" type="text" data-msg="Paper Number" name="paper_sub_title">
