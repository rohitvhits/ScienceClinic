                ...
                <div class="card card-custom card-stretch">
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            <h3 class="card-label font-weight-bolder text-dark">Add Student</h3>
                        </div>
                    </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker" required id="subject_name" name="subject_name" aria-label="Default select example" data-live-search="true">
                                            ...
                                            @foreach($teacher_subject_list as $key => $sval)
                                                <option value="{{$sval->subject_id}}">{{$sval->main_title}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control validate_field" placeholder="Enter Level" autocomplete="off" id="level" type="text" data-msg="Level" name="level">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control validate_field" placeholder="Enter Year Group" autocomplete="off" id="year_group" type="text" data-msg="Year Group" name="year_group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control validate_field" placeholder="Enter Parent Name" autocomplete="off" id="parent_name" type="text" data-msg="Parent Name" name="parent_name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control validate_field" placeholder="Enter Parent Address" autocomplete="off" id="parent_address" type="text" data-msg="Parent Address" name="parent_address">
