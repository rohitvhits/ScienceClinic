                    ...
                    <div class="text-content-wrapper text-center full-width">
                        <div class="text-content text-center-content">
                            <h1 class="title1 text-center max-englishtext mb-20">
                                <span class="tlt block" data-in-effect="fadeInRight" data-out-effect="fadeOutRight">Spanish Tuition</span>
                            </h1>
                            <p>
                                Science Clinic Private Tutors work with a range of teachers from different
                                schools who deliver
                                Spanish specifications from different exam boards. We have focussed on
                                ensuring that the
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12 res-mb-40">
                <div>
                    <img src="{{asset('front/img/languages/spanish1.jpg')}}" class="w-100">
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
                <div class="qualified-text res-mt-20">
                    ...
                    <div class="qualified-details">
                        <p>Our objective is to enable students of all abilities to develop their Spanish
                            language skills to their full
                            potential, equipping them with the knowledge to communicate in a variety of
                            contexts with
                            confidence.</p>
                        <p>
                            Our tutors are fully qualified to teach Spanish, they are all educated to the
                            minimum of a degree,
...
<!--End of About Area-->
<div class="english-abc spnish-language">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12">
                <div>
                    <img src="{{asset('front/img/languages/spanish2.jpg')}}" class="img-sci-bios" alt="bio-text">
                </div>
            </div>
        </div>
    </div>
...
<div class="relevant-specific biology-relevant">
    <div class="container">
        <div class="relevant-and-diverse">
            ...
            <p>We have attached Spanish qualifications from different exam boards that we work with.</p>
        </div>

    </div>
</div>
<div class="gcse-text res-mb">
    <div class="container">
        <div class="gcseflexcenter spanish-center">
            ...
            <div class="relevant-and-diverse">
                ...
                <p class="pt-2 pb-2">
                    We teach the following specifications in Spanish
                </p>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="chemistry-icon-text">
                    <a href="{{asset('uploads/all_subject/pdf/subjects_pdf/SPANISH-GCSE-SPEC.PDF')}}" target="_blank" class="btn download-pdfs"><i class="fa fa-book mr-2"></i>
                        Spanish GCSE</a>
                </div>
                <div class="chemistry-icon-text">
                    <a href="{{asset('uploads/all_subject/pdf/subjects_pdf/SPANISH-GCSE-SPEC-NI-PDF.pdf')}}" target="_blank" class="btn download-pdfs"><i class="fa fa-book mr-2"></i>Spanish GCSE NI</a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="chemistry-icon-text">
                    <a href="{{asset('uploads/all_subject/pdf/subjects_pdf/SPANISH-GCSE-SPEC-EDUQAS-WJEC-PDF.pdf')}}" target="_blank" class="btn download-pdfs"><i class="fa fa-book mr-2"></i>Spanish GCSE EDUQAS WJEC</a>
                </div>
                <div class="chemistry-icon-text">
                    <a href="{{asset('uploads/all_subject/pdf/subjects_pdf/SPANISH-GCSE-SPEC-EDEXCEL-PDF.pdf')}}" target="_blank" class="btn download-pdfs"><i class="fa fa-book mr-2"></i>Spanish GCSE EDEXCEL </a>
                </div>
                <div class="chemistry-icon-text">
                    <a href="{{asset('uploads/all_subject/pdf/subjects_pdf/SPANISH-AQA-A-LEVEL-SPEC.PDF')}}" target="_blank" class="btn download-pdfs"><i class="fa fa-book mr-2"></i>A-Level Spanish AQA
                    </a>
                </div>
